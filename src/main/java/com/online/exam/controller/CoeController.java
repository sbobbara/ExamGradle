...
private Integer qId;
	...
	public ResponseEntity<Questions> deleteQuestions(@PathVariable("qid") Integer questionId,HttpServletRequest request) {
		HttpSession session= request.getSession();

		coeService.deleteQuestions(questionId);
...
//	}
	@GetMapping("/findqid/{qid}")
	public ResponseEntity<?> findQuestions(@PathVariable("qid") Integer questionId){
//		ResponseEntity<?> entity=null;
//		Questions dbq=coeService.findByquestionId(questionId);
//		entity=new ResponseEntity<Questions>(dbq,HttpStatus.OK);
		return new ResponseEntity<Questions>(coeService.getQuestionById(questionId), HttpStatus.OK);
	}
...
//		}
	...
	@GetMapping("/findqbid/{qbid}")
	public ResponseEntity<?> findQuestionBank(@PathVariable("qbid") int quesbankId){
//		ResponseEntity<?> entity=null;
//		
//		
//		QuestionBank questionbank= QuesBService.findByquesbankid(quesbankId);
//		
//		entity=new ResponseEntity<QuestionBank>(questionbank,HttpStatus.OK);
		
		 return new ResponseEntity<QuestionBank>(QuesBService.getQuestionBankById(quesbankId), HttpStatus.OK);
	}
